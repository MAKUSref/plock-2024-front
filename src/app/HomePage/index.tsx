...
import { useGetCoursesQuery, useGetMyCoursesQuery } from "@/redux/api/courseApi";
        ...
        {courses && (
          <div className="mb-10">
            <h3 className="text-4xl">
              ...
              <span className="text-primary bg-opacity-100">{selfInfo?.name}</span>
            </h3>
            <p className="text-base text-slate-500 mb-9">
              {userRole === "lecturer" && "Oto najbliższe twoje szkolenia, które poprowadzisz"}
              {userRole === "user" && "To najbliższe szkolenia na które jesteś zapisany"}
            </p>
